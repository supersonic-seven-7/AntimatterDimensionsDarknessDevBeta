...
export const ecTimeStudies = [
  ...
  },
  {
    ...
    secondary: {
      ...
      required: completions => 192 + Math.min(completions, 4) * 8,
      formatValue: formatInt
    }
  },
  {
    ...
    secondary: {
      ...
      required: completions => DC.E1_6E6.pow(Math.min(completions, 4)).times(DC.E1_39E7),
  ...
  },
  {
    ...
    secondary: {
      ...
      required: completions => DC.E92000.pow(Math.min(completions, 4)).times(DC.E72000),
      formatValue: value => format(value)
    }
  },
  {
