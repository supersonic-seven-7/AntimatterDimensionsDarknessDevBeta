...
export class Galaxy {
  ...
  static get costMult() {
    return Effects.min(NormalChallenge(10).isRunning || UltimateChallenge(1).isRunning ? 90 : 60);
  }

  static get baseCost() {
    return NormalChallenge(10).isRunning || UltimateChallenge(1).isRunning ? 99 : 80;
  }
