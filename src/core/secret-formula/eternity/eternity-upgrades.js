...
export const eternityUpgrades = {
  ...
  idMultICRecords: {
    ...
    effect: () => (InfinityChallenge(13).isCompleted ? DC.E1.pow(184.8 / Math.clampMin(Time.infinityChallengeSum.totalSeconds - player.challenge.infinity.bestTimes[13], 0.6)) : DC.E1.pow(184.8 / Math.clampMin(Time.infinityChallengeSum.totalSeconds, 0.6))),
    cap: DC.E300,
    formatEffect: value => formatX(value, 2, 1)
  },
  tdMultAchs: {
