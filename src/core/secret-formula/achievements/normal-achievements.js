...
export const normalAchievements = [
  ...
  },
  {
    ...
    checkRequirement: () => Time.totalTimePlayed.totalDays >= 0.333333333333333,
    checkEvent: GAME_EVENT.GAME_TICK_AFTER,
  ...
  },
  {
    ...
    get description() { return `Eternity with less than or equal to ${formatInt(9)} Replicanti.`; },
    checkRequirement: () => Replicanti.amount.round().lte(9),
    checkEvent: GAME_EVENT.ETERNITY_RESET_BEFORE
  },
  {
    id: 111,
  ...
  },
  {
    ...
    checkEvent: GAME_EVENT.ETERNITY_RESET_BEFORE,
    get reward() { return `Gain ${formatX(5)} more Eternities.`; },
    effect: 5,
  },
  {
    id: 114,
  ...
  },
  {
    ...
    effect: () => Decimal.pow(Currency.infinitiesTotal.value.clampMin(1), 3).powEffectOf(TimeStudy(31)),
  ...
  },
  {
    ...
    get description() {
      return `Reach ${format(DC.E69)} Infinity Points without having any Infinities
      or any 1st Antimatter Dimensions in your current Eternity.`;
    },
    checkRequirement: () => Currency.infinityPoints.exponent >= 69 &&
    ...
    effect() {
      ...
      return DC.E1.pow(Math.log(thisInfinity) * Math.min(Math.pow(thisInfinity, 0.33), 10000));
    },
    cap: () => Effarig.eternityCap,
    formatEffect: value => `${formatX(value, 2, 2)}`
  },
  ...
  },
  {
    ...
    get description() {
      return `Reach ${formatPostBreak(DC.E70000)} Infinity Points without
  ...
  },
  {
    ...
    get description() {
      return `Get ${formatPostBreak("1e2600000")} antimatter
      in ${formatInt(1)} minute or less while Dilated.`;
    },
    checkRequirement: () =>
      Currency.antimatter.exponent >= 2600000 &&
